...
<head>
    ...
    <meta name="description" content="<?php $row->isi ?>">
                                ...
                                <nav id="desktop-nav">
                                    <ul>
                                        ...
                                        <li class="<?php if($this->uri->segment(2) == 'struktural') echo 'active' ?>"><a>Layanan Publik</a>
                                              <ul>							
												<li class="<?php if($this->uri->segment(2) == 'ebang') echo 'active' ?>"><a href="https://ebang.kaltaraprov.go.id/">Aplikasi Pelaporan Realisasi Fisik Keuangan Pemerintah Daerah (e-bang)</a></li>											  
                                                <li class="<?php if($this->uri->segment(2) == 'sop') echo 'active' ?>"><a href="https://drive.google.com/drive/folders/1ZYhANyWA-Pu6vtcKnhKKrRj8PUc1_4Aw?usp=share_link">SOP</a></li>
                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    ...
                                    <li class=""><a href="home">Home</a>
										   ...
										   <ul>
											<li><a href="http://ebang.kaltaraprov.go.id">Aplikasi Pelaporan Realisasi Fisik Keuangan Pemerintah Daerah (e-bang)</a></li>
                                               <li><a href="https://drive.google.com/drive/folders/1ZYhANyWA-Pu6vtcKnhKKrRj8PUc1_4Aw?usp=share_link">SOP</a></li>
